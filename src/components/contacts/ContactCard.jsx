"use client";
import {
    ArrowLeftRounded, Delete, Edit, RemoveRedEye,
} from "@mui/icons-material";
import {
    Card as CardItem, CardActionArea, CardMedia, CardContent, Box, Typography, CardActions, Divider, Button, Tooltip,
} from "@mui/material";
...
const ContactCard = ({user: {username, avatar, name, phone, email, id}}) => {
    ...
    return (<Grid xs={12} sm={12} md={4} lg={4} xl={4} mb={5}>
        <CardItem
            sx={{
                bgcolor: "card.main", maxWidth: {
                    xs: "100%", sm: "85%",
                }, m: "0 auto",
            }}
        >
